...
const DeleteCollectionDialog = ({collection,entriesCount = 0}) => {
    ...
    useEffect(()=> {
        if(deletedCollection && !iseDeleting) {
            setOpen(false)
            toast.error(
        ...
        <AlertDialog open = {open} onOpenChange = {setOpen}>
            ...
            <AlertDialogContent>
                ...
                <AlertDialogAction asChild>
                    <Button onClick={handleDelete} className="bg-red-500 hover:bg-red-600" disabled = {iseDeleting}>{iseDeleting ?"Deleting...":"Delete Collection"}</Button>
                </AlertDialogAction>
                </AlertDialogFooter>
            </AlertDialogContent>
        </AlertDialog>
