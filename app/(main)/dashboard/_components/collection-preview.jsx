...
const CollectionPreview = ({ id, name, entries = [], isUnorganized = false, isCreateNew = false, onCreateNew}) => {
    if (isCreateNew) {
        return (
            <button onClick={onCreateNew} className="relative group h-[200px] cursor-pointer">
