...
const JournalEntryPage = () => {
    ...
    const {register, handleSubmit, control, formState: {errors, isDirty}, watch, setValue, reset}= useForm({
    ...
    useEffect(() => {
        if(actionResult && !actionLoading){
            ...
            if(!isEditMode){ //Clearing draft when creating a new journal entry
                saveDraftFn({
                    title: "",
                    content: "",
                    mood: ""
        ...
        <div className="py-8">
            <form className="space-y-2 mx-auto" onSubmit={onSubmit}>
                ...
                <div className="space-x-4 flex mt-3">
                    ...
                    <Button type="submit" variant="journal" disabled = {actionLoading || !isDirty}>{isEditMode ? "Update" : "Publish"}</Button>
                    {
                        isEditMode && (
                            <Button
                                onClick = { (e) => {
